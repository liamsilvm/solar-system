...
let toggleNoFill = false
function setBackground(color, op){ 
...
function calculateSpeed(body1, body2) {
  ...
  let momentum_x = body2.speed_x
  let momentum_y = body2.speed_y
...
let noFillToggle = document.getElementById('no-fill')
//zoom html
...
noFillToggle.addEventListener('input', (e) => { 
  console.log(e.target.value)
  toggleNoFill = !toggleNoFill
})
